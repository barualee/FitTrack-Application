    ...
    if request.method =="POST":
        ...
        try:
            ...
            with open(os.path.join(directory ,filename), 'w') as f:
             f.write(filedata)
            data=pd.read_csv(r'/Users/Dell/Desktop/django/DjangoAPI/MyAPI/datasheet/{}')
            # filedata.dropna(inplace=True)

            # filedata['Timestamp'] = pd.to_datetime(filedata['Timestamp'], unit='ms')
            # filedata['Magnitude'] = np.sqrt(filedata['X']**2 + filedata['Y']**2 + filedata['Z']**2)
